      ...
      <StLogo>
        <StLogoSvg>
          <g clipPath="url(#clip0_511_8280)">
            <path
              d="M35.7765 31.1449L51.2267 51.8635H41.711L30.4559 36.721L23.6005 44.0797V51.892H15.8242V15.3738H23.6005V32.9274L40.5324 15.2773H51.041L35.7765 31.1449Z"
            />
            <path
              d="M84.9733 51.692H78.0649L63.5469 31.9343V51.6991H57.457V23.0039H64.3655L78.8683 42.883V23.0039H84.9733V51.692Z"

            />
            <path
              d="M170.538 35.4109L182.664 51.6928H175.195L166.358 39.7939L160.976 45.5487V51.6821H154.879V23.0298H160.984V36.8112L174.282 22.9512H182.516L170.538 35.4109Z"

            />
            <path
              d="M105.502 22.6875C96.3422 22.6875 90.0742 29.3139 90.0742 37.3334C90.0742 45.3529 96.3422 51.9793 105.502 51.9793C114.661 51.9793 120.925 45.3886 120.925 37.3334C120.925 29.2781 114.657 22.6875 105.502 22.6875ZM105.502 46.9997C103.786 47.0166 102.102 46.5596 100.659 45.6851C103.758 44.8921 106.085 41.5985 106.085 37.6513C106.085 33.4147 103.402 29.9283 99.9575 29.4853C101.532 28.3048 103.49 27.6737 105.502 27.6992C111.243 27.6992 114.82 32.4359 114.82 37.3441C114.82 42.2522 111.243 46.9997 105.502 46.9997Z"
...
const StNavButton = styled.button<{ active?: boolean }>`
  ...
  padding-left: 14.95%;
  padding-right: 12.89%;
  color: ${({ active, theme }) => (active ? theme.keyBlue : theme.lightGrey)};
  background: none;
  border: 0;
  ...
  border-left: 10px solid
    ${({ active, theme }) => (active ? theme.keyBlue : "transparent")};
  fill: ${({ active, theme }) => (active ? theme.keyBlue : theme.lightGrey)};
  stroke: ${({ active, theme }) => (active ? theme.keyBlue : theme.lightGrey)};
`;
